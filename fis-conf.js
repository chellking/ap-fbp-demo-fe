...
var moduleIdPre =  pkgName + '^'; //   'i_uap/' + pkgName + '^';
...
fis.match('src/widgetVue/(**).vue', {
    isMod: true,
    moduleId: moduleIdPre + './widgetVue/' + '$1' + '.vue',
    rExt: 'js',
    useSameNameRequire: true,
    parser: [
        parserVuePlugin,
