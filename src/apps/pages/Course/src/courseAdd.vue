...
<script>
  ...
  export default {
    data() {//页面初始化
      return {
        // 主表所需参数
        courseInfoFunnode: "BU01", //funnode参数指定平台UI模板定义值
        courseInfoNexuskey: "KCTemp",//funnode参数指定平台UI模板定义值
        courseInfoData: {},
        // 子表所需参数
        courseFormFunnode: "BU01",//funnode参数指定平台UI模板定义值
        courseFormNexuskey: "Course",//funnode参数指定平台UI模板定义值
        courseFormData: {}
      }
    },
